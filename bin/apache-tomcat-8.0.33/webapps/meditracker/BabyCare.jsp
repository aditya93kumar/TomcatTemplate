...
String query="select * from babycare";
	...
	PreparedStatement ps=con.prepareStatement(query);
		   ...
		   { 
		    ...
		    %>
<div class="col-lg-3"><a href="BabyCare1.jsp?id=<%= s4 %>" style="text-decoration:none;"><img src=<%=s2 %> style="width:80%; height:200px;" /><hr/><center><div style="height:40px;"><%= s1 %></div></center><br/><hr/><h4>RS.</h4><center><%= s3 %></center><hr/></a> </div>
