...
<br/>
    ...
    <div class="form-group"> 
       ...
       <div class="row"  >
                    ...
                    <div class="col-sm-9" style="width:160px;">
                        <input type="text" class="form-control width="100px" name="pid" id="subj" placeholder="product id" required>
                        
                    </div>
					
					<div class="col-lg-4">
					   <form onClick="UpdateMedicals1.jsp" method="post">
					  <input type="submit" name="submit" id="submit" value="submit" class="btn btn-info "></form>
					</div>
    ...
    <div class="form-group"> 
       ...
       <div class="row"  >
					...
					<td>
                    <div class="col-sm-9" style="width:160px;">
                        <input type="file" class="form-control width="100px" name="pimage" id="subj2" placeholder="choose image" required>
