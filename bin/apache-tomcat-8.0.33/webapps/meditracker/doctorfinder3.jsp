...
<div class="panel panel-info">
      <div class="panel-heading"><b>Fill Your Details </b> </div>
...
<div style= "width:300px; height:270px;"class="animated fadeInUp">
	<form action="doctorfinder4.jsp" method="post" name="myForm" onSubmit="return(validate());">
    ...
    <label ><input type="checkbox"> Remember me</label>
		...
		<div class="form-group" >
		<button type="submit" name="Submit" class="mbr-buttons__btn btn btn-mg btn-danger" >Book Appointment</button>
		</div>
