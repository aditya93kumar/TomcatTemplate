...
<head>
  ...
  <title>MEDITRACKER | Doctor Finder and Book Appointmen</title>
            ...
            <div class="mbr-navbar__container">
                <div class="mbr-navbar__column mbr-navbar__column--s mbr-navbar__brand">
                    <span class="mbr-navbar__brand-link mbr-brand mbr-brand--inline">
                        <span class="mbr-brand__logo"><a href="#top"><img src="assets/images/imageedit-9-2954139493-123x121-94-123x121-81.png" class="mbr-navbar__brand-img mbr-brand__img"></a></span>
                        <span class="mbr-brand__name"><a class="mbr-brand__name text-white" href="shop.html">MEDITRACKER</a></span>
                    </span>
                </div>
                ...
                <div class="mbr-navbar__column mbr-navbar__menu">
                    <nav class="mbr-navbar__menu-box mbr-navbar__menu-box--inline-right">
						...
						<li class="mbr-navbar__item"><a class="mbr-buttons__link btn text-white" href="index.html#slider-8">HOME</a></li>
						<li class="mbr-navbar__item"><a class="mbr-buttons__link btn text-white" href="index.html#features1-8" target="_blank">ABOUT</a></li> 
						<li class="mbr-navbar__item"><a class="mbr-buttons__link btn text-white" href="index.html#features1-14" target="_blank">SERVICES</a></li>
						<li class="mbr-navbar__item"><a class="mbr-buttons__link btn text-white" href="index.html#form1-15" target="_blank">CONTACT</a></li>
						...
						<li class="mbr-navbar__item"><nav class="main-nav"><a class="mbr-buttons__btn btn btn-danger cd-signin" href="#0">Login | For Doctors</a></nav></li></ul></div>
                    </nav>
                </div>
            </div>
        </div>
...
String query="select * from dinfo where specification=?";
...
<div style="width:60%; height:250px; border:groove;"class="animated fadeInUp">
 <div style="width:25%; height:40px; float:left"class="animated fadeInLeft"><center><br><img src="<%=p2 %>"/></center></div>
 <div style="width:50%; height:40px;float:left"class="animated fadeInLeft">
 <div style="width:120%; height:40px; float:left"><h3 align="left"><font color="#81BEF7"><b>Dr. <%=p1 %></b></font></h3></div>
 ...
 <div style="width:120%; height:40px; float:right;"class="animated fadeInDown"> 
  <center><form action="doctorfinder3.jsp" method="post"><input type="submit" name="submit" id="submit" value="Book Appointment" class="btn btn-info pull-left"></form></center></div>
