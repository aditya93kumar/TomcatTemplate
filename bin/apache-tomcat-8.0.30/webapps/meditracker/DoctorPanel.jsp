...
<table class="table">
 <caption><center>Appintment Request</center></caption>
 <thead>
 <tr>
 <th>Patient Name</th>
 <th>Contact No</th>
...
String query1="select * from request where dname=?";
	...
	ps1.setString(1,""+session.getAttribute("D1"));
 ...
 <tbody>
 <tr class="active">
 <td><h5 align="left"><font color="#666666"><b><%= p %></b></font></h5></td>
 <td><h5 align="left"><font color="#666666"><%=q%></font></td>
 <td><h5 align="left"><font color="#666666"><%=r%></font></td>
 <td><center><form action="AcceptRequest.jsp?id=<%= q %>" method="post"><input type="submit" name="submit" id="submit" value="Accept" class="btn btn-info pull-left"></form></center></td>
 <td><center><form action="DeclineRequest.jsp?id=<%= q %>" method="post"><input type="submit" name="submit" id="submit" value="Decline" class="btn btn-info pull-left"></form></td>
 </tr>
 </tbody>
</table>
</center>
