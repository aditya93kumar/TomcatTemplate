...
<%
	 ...
	 %>
						...
						<li class="mbr-navbar__item"><nav class="main-nav"><a class="mbr-buttons__btn btn btn-danger cd-signin" href="User.jsp">Login | For Dealers</a></nav></li></ul></div>
...
<table class="table">
 <caption><center>All Delivery Request</center></caption>
 <thead>
 <tr>
 <th>Order-id</th>
...
String query1="select * from order1";
 ...
 <td><center><form action="DeliveryRequest.jsp?id=<%= p %>" method="post"><input type="submit" name="submit" id="submit" value="Delivered" class="btn btn-info pull-left"></form></td>
 </tr>
 </tbody>
</table>
</center>
