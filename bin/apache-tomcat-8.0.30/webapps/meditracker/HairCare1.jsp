...
PreparedStatement ps=con.prepareStatement(query);
  ...
  <img src=<%=t%>  style="width:90%; height:90%;" />
   ...
   <div class="row" style="width:100%; height:10%; background-color:#FFFFFF; float:left;">Delivery Time: <%=r%></div>
   ...
   <div class="row" style="width:100%; height:20%; background-color:#FFFFFF; float:left;"><p><b>Description:</b><br>
<%=q%></p></div>
   </div>
